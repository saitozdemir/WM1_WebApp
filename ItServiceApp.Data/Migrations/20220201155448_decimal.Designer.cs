...
namespace ITServiceApp.Migrations
{
    ...
    [Migration("20220201155448_decimal")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITServiceApp.Models.Identitiy.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ITServiceApp.Models.Identitiy.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ITServiceApp.Models.Entities.Address", b =>
                {
                    ...
                    b.HasOne("ITServiceApp.Models.Identitiy.ApplicationUser", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ITServiceApp.Models.Entities.Subscription", b =>
                {
                    ...
                    b.HasOne("ITServiceApp.Models.Identitiy.ApplicationUser", "ApplicationUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ITServiceApp.Models.Identitiy.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ITServiceApp.Models.Identitiy.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
